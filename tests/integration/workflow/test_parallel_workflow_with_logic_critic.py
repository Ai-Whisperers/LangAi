...
class TestQualityCheckNode:
    ...
    def test_check_quality_with_logic_critic_output(self):
        ...
        state = {
            ...
            "agent_outputs": {
                "logic_critic": {
                    "facts_analyzed": 42,
                    "contradictions": {"total": 2, "critical": 0, "high": 1},
                    "gaps": {
                        "total": 5,
                        "high_severity": 1,
                        "items": [
    ...
    def test_check_quality_fallback_without_logic_critic(self):
        ...
        with patch(
            "company_researcher.workflows.parallel_agent_research.check_research_quality"
        ) as mock_check:
            ...
            state = {"company_name": "TestCorp", "company_overview": "Test overview", "sources": []}
...
class TestDecisionFunctions:
    ...
    def test_should_continue_with_high_quality(self):
        ...
        state = {"quality_score": 90.0, "iteration_count": 1}
    ...
    def test_should_continue_with_low_quality(self):
        ...
        state = {"quality_score": 70.0, "iteration_count": 1}
    ...
    def test_should_finish_at_max_iterations(self):
        ...
        state = {"quality_score": 50.0, "iteration_count": 2}  # Max iterations
...
class TestFullWorkflowExecution:
    ...
    def test_workflow_invocation_with_mocks(self):
        ...
        with (
            patch("company_researcher.agents.researcher_agent_node") as mock_researcher,
            ...
            patch(
                "company_researcher.agents.quality.logic_critic.logic_critic_agent_node"
            ) as mock_critic,
        ):
    ...
    def test_workflow_iteration_with_low_quality(self):
        ...
        with (
            ...
            mock_synthesizer.return_value = {
                "agent_outputs": {
                    "synthesizer": {"company_overview": "Limited analysis", "cost": 0.002}
                },
...
class TestLogicCriticIntegration:
    ...
    def test_logic_critic_receives_all_agent_outputs(self):
        ...
        with (
            ...
            mock_synthesizer.return_value = {
                "agent_outputs": {
                    "synthesizer": {"company_overview": "Synthesized", "cost": 0.002}
                },
