    ...
    async def _check_mediastack(self) -> QuotaInfo:
        ...
        try:
            ...
            response = await self.client.get(
                ...
                params={
                    "access_key": self.keys["mediastack"],
                    "countries": "us",
                    "limit": 1
                }
            )
    ...
    async def _check_hunter(self) -> QuotaInfo:
        ...
        try:
            ...
            response = await self.client.get(
                ...
                params={"api_key": self.keys["hunter"]}
            )
