...
from src.company_researcher.config import ResearchConfig, get_config
        ...
        try:
            ...
            if extracted_str and all_sources:
                quality_result = check_research_quality(
                    company_name=company_name, extracted_data=extracted_str, sources=all_sources
                )
...
def save_comprehensive_report(
    company_name: str, result: Dict[str, Any], profile_data: Dict[str, Any], output_dir: Path
) -> Path:
    ...
    for company_name, profile_path in companies:
        ...
        try:
            ...
            if result:
                ...
                results.append(
                    {"company": company_name, "success": False, "error": "No result returned"}
                )
